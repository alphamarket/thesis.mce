...
%Create Test 1
    ...
    test{1}.environment=@PredatorPrey;
    ...
    test{1}.group{1}.name='MCE fci-mean';
    test{1}.group{1}.type='MCE-FCI';
    test{1}.group{1}.fci_method='mean';
    test{1}.group{1}.show='--R';
    test{1}.group{1}.micro=0.5;

    test{1}.group{2}.temperature=0.10;
    ...
    test{1}.group{2}.name='MCE fci-max';
    test{1}.group{2}.type='MCE-FCI';
    test{1}.group{2}.fci_method='max';
    test{1}.group{2}.show='.g';
    test{1}.group{2}.micro=0.5;

    test{1}.group{3}.temperature=0.10;
    ...
    test{1}.group{3}.name='MCE fci-k-mean';
    test{1}.group{3}.type='MCE-FCI';
    test{1}.group{3}.fci_method='k-mean';
    test{1}.group{3}.show='*B';
    test{1}.group{3}.micro=0.5;

    test{1}.group{4}.temperature=0.10;
    ...
    test{1}.group{4}.name='MCE fci-const-one';
    test{1}.group{4}.type='MCE-FCI';
    test{1}.group{4}.fci_method='const-one';
    test{1}.group{4}.show='-k';
    test{1}.group{4}.micro=0.5;
